...
#include "app_context.h"
	...
	extern unsigned long monotonic_time;
	extern struct RastaIPData toServer[2];
#endif
 ...
 * @param id
 */
void sr_connect(struct rasta_handle *handle, unsigned long id, struct RastaIPData *channels,struct app_context *ctx);
...
void sr_begin(struct rasta_handle * h, fd_event * extern_fd_events, int len, timed_event * extern_timed_events,int len_timed_event,timed_event * e2);
